 ...
 */
public class ListIndividualSuccessStoryActivity_4ee extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Toast box = Toast.makeText(ListIndividualSuccessStoryActivity_4ee.this, display, Toast.LENGTH_LONG);
        ...
        webView.loadUrl("file:///android_asset/chartSuccessStoryIndividual.html");
    }
